...
chile_1999 <- set_label(chile_1999, c("WEIGHT", "Educacion", "Sexo", "Percibido: Doctor", "Percibido: Gerente", "Percibido: Asistente de tienda", "Percibido: Obrero", "Percibido: Ministro de Gobierno", "Justo: Doctor", "Justo: Gerente", "Justo: Asistente de tienda", "Justo: Obrero", "Justo: Ministro de Gobierno"))
```
...
chile_2009 <- set_label(chile_2009, c("WEIGHT", "Educacion", "Sexo", "Percibido: Doctor", "Percibido: Gerente", "Percibido: Asistente de tienda", "Percibido: Obrero", "Percibido: Ministro de Gobierno", "Justo: Doctor", "Justo: Gerente", "Justo: Asistente de tienda", "Justo: Obrero", "Justo: Ministro de Gobierno"))
```
...
chile_2019 <- set_label(chile_2019, c("WEIGHT", "Educacion", "Sexo", "Percibido: Doctor", "Percibido: Gerente", "Percibido: Asistente de tienda", "Percibido: Obrero", "Percibido: Ministro de Gobierno", "Justo: Doctor", "Justo: Gerente", "Justo: Asistente de tienda", "Justo: Obrero", "Justo: Ministro de Gobierno"))
```

* Educacion

```{r}
table(chile_2019$educacion_rec)
