...
data_rec <- data %>% select(WEIGHT=pondera_total,
                        sexo,
                        educacion=p51,
                        p12_aleatorio, # 1= cajero gerenta doctora diputado; 0= cajera gerente doctor diputada
...
data_rec$cajera <- ifelse(data_rec$p12_aleatorio==1, 1, 0)
data_rec$gerenta <- ifelse(data_rec$p12_aleatorio==0, 1, 0)
