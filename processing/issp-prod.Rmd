...
labels <- c(brecha_just_2009 = "Brecha justa", brecha_perc_2009 = "Brecha percibida")
...
cleveland <- brecha %>% 
  ...
  xlab("Brecha justa") +
  xlim(0,60) + 
  facet_wrap(~year, labeller=labeller(year = labels))+
...
ggsave(cleveland, file="output/graphs/cleveland2009.png", width = 12,height = 6)
```
...
```{r}
brecha <- arrange(brecha, mean)
labels <- c(brecha_just_2019 = "Brecha justa", brecha_perc_2019 = "Brecha percibida")
...
cleveland
ggsave(cleveland, file="output/graphs/cleveland2019.png", width = 12,height = 6)
```
...
htmlreg(list(reg1, reg2, reg3, reg5, reg6, reg7, reg8),
        custom.model.names = c(rep("Brecha percibida", 3),
                               rep("Brecha justa",4)),
        doctype = FALSE,
